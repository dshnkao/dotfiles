...
myKeys myTerm =
  ...
  , ((mod4Mask .|. shiftMask,   xK_i            ), spawn "$HOME/bin/carbon-edp.sh")
  , ((mod4Mask .|. shiftMask,   xK_e            ), spawn "$HOME/bin/carbon-hdmi.sh")
  ...
  , ((mod4Mask,                 xK_i            ), spawn "$HOME/bin/rofi-books.sh")
  , ((mod4Mask,                 xK_o            ), spawn "$HOME/bin/rofi-password-store.sh")
